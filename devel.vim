...
badd +1 config/initializers/load_koala_facebook.rb
badd +1 ~/Efamily/efamily/config/facebook.yml
badd +1 config/facebook.yml
badd +0 app/controllers/facebook_sessions_controller.rb
args public/javascripts/fb.js
edit app/controllers/facebook_sessions_controller.rb
...
1
normal! 0
tabedit app/views/sessions/new.html.erb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 17 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
